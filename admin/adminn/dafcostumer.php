...
<body>
  ...
  // Load file koneksi.php
												require_once '../../action/koneksi.php';
  														...
  														$query = "SELECT * FROM costumer"; // Query untuk menampilkan semua data siswa
  														...
  														while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
  															...
  															echo "<td>
  															<a class='fa fa-edit' href='editcostumer.php?id=".$data['id']."'></a>
  															<a class='fa fa-trash-o' href='deletcostumer.php?aksi=delete&id=".$data['id']."'></a>
  														</td>";
